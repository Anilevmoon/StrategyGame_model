...
void TMilitary::UseBuff(TBuffs* buff) {
...
void TMilitary::ConfirmBaffToVector(TBuffs* buff) {	if(buff->m_xPrototype->m_iMoveNumbers>0) m_vBuffs.push_back(buff); }

void TMilitary::TakeBuff(TBuffs* buff) {
	UseBuff(buff);
